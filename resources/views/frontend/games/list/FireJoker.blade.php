...
<body style="margin:0px;width:100%;background-color:black;overflow:hidden">
    <iframe id='game' style="position:absolute;top:0px;margin:0px;border:0px;width:100%;height:100vh;" src='/games/{{ $game->name }}/GameLoader/Casino/IframedView.html?pid=2&gid=firejoker&gameId=307&lang=en_GB&practice=1&channel=@if($is_mobile==true){{"mobile"}}@else{{"desktop"}}@endif&div=flashobject&width=100%&height=100%&user=&password=&ctx=&demo=0&brand=&lobby=&rccurrentsessiontime=0&rcintervaltime=0&rcaccounthistoryurl=&rccontinueurl=&rcexiturl=&rchistoryurlmode=&autoplaylimits=0&autoplayreset=0&callback=flashCallback&rcmga=&resourcelevel=0&hasjackpots=False&country=&pauseplay=&playlimit=&selftest=&sessiontime=&coreweburl=/&showpoweredby=True' allowfullscreen>
</iframe>
