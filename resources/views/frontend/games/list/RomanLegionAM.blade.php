...
<iframe id='game' style="margin:0px;border:0px;width:100%;height:100vh;" src='/games/RomanLegionAM/amarent/index.html?game=romanlegion&hash=&lang=en&protokol=wss&server=&port=&socket=&exit=&balanceInCash=1&m=&w=w1&curr=@if( auth()->user() != null && auth()->user()->present()->shop ){{ auth()->user()->present()->shop->currency }}@endif' allowfullscreen>
