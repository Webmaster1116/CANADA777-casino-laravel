...
document.location.href='../../../';	
	...
	return 4;
			        ...
			        if(document.location.href.split("?")[1]==undefined){
		document.location.href=document.location.href+'/?game=lightninghot&hash=&lang=en&protokol=wss&server=&port=&socket=&exit=&balanceInCash=1&m=&w=w1&curr=@if( auth()->user() != null && auth()->user()->present()->shop ){{ auth()->user()->present()->shop->currency }}@endif';	
		}else{
	/*------------------------------------------------*/
