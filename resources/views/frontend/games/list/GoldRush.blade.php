...
<iframe id='game' style="margin:0px;border:0px;width:100%;height:100vh;" src='/games/GoldRush/index.html?lang=en&cur=@if( auth()->user() != null && auth()->user()->present()->shop ){{ auth()->user()->present()->shop->currency }}@endif&extGame=1&gameSymbol=vs25goldrush&websiteUrl=&lobbyURL=' allowfullscreen>
