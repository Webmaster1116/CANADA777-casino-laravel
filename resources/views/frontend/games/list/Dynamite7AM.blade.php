...
<iframe id='game' style="position:fixed;top:0px;margin:0px;border:0px;width:100%;height:100vh;" src='/games/Dynamite7AM/mobile/dynamite7.html/?curr=@if( auth()->user() != null && auth()->user()->present()->shop ){{ auth()->user()->present()->shop->currency }}@endif&lang=en&w=&lang=en' allowfullscreen>
