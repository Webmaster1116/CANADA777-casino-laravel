<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="{{ Request::is('backend/notifications*') ? 'active' : ''  }}">
                <a href="{{ route('backend.notifications.list') }}">
            ...
            @if( !(auth()->check() && auth()->user()->shop_id == 0 && auth()->user()->role_id < 6) )
            <li class="{{ (Request::is('backend/bonus') || Request::is('backend/bonus/*')) ? 'active' : ''  }}">
                <a href="{{ route('backend.bonus.list') }}">
            ...
            @permission('freespinround.manage')
            @if( !(auth()->check() && auth()->user()->shop_id == 0 && auth()->user()->role_id < 6) )
            <li class="{{ (Request::is('backend/freespinround') || Request::is('backend/freespinround/*')) ? 'active' : ''  }}">
                <a href="{{ route('backend.freespinround.list') }}">
                    <i class="fa fa-gift"></i>
                    <span>@lang('app.freespinround')</span>
                </a>
            </li>
            @endif
            @endpermission
            ...
            @permission('automizy.manage')
            <li class="{{ Request::is('backend/automizy*') ? 'active' : ''  }}">
                <a href="{{ route('backend.automizy.list') }}">
                    <i class="fa fa-circle-o"></i>
                    <span>@lang('app.automizy')</span>
                </a>
            </li>
            @endpermission
            @permission('freespinround.manage')
            <li class="{{ Request::is('backend/freeplay*') ? 'active' : ''  }}">
                <a href="{{ route('backend.freeplay.list') }}">
                    <i class="fa fa-circle-o"></i>
                    <span>@lang('app.free_play')</span>
                </a>
            </li>
            @endpermission
        </ul>
