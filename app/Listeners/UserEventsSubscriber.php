...
class UserEventsSubscriber
{
    ...
    public function onRequestPasswordResetEmail(RequestedPasswordResetEmail $event)
    {
    ...
    public function subscribe($events)
    {
        ...
        $events->listen(RequestedPasswordResetEmail::class, "{$class}@onRequestPasswordResetEmail");
